        ...
        <div className="relative z-10">
          ...
          <div className="mt-16">
            ...
            <p className="text-blue-100 text-lg leading-relaxed">
              Collaborate with your team, track tasks, and deliver projects on time with our powerful management platform.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 text-white">
              ...
              <span className="text-blue-50">Advanced task tracking</span>
            </div>
            <div className="flex items-center gap-3 text-white">
              <div className="w-8 h-8 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                <span className="text-xl font-bold text-black">✓</span>
              </div>
              <span className="text-blue-50">Seamless team management</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-xl font-medium hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98]"
              >
                {loading ? (
